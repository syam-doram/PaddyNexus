...
export default function PaddyEarn() {
  ...
  const exportToPDF = () => {
    ...
    doc.text("PaddyManager Enterprise | Strategic Partner Audit", 14, 37);
    ...
    autoTable(doc, {
      ...
      didDrawPage: (data) => {
        ...
        doc.text(`CONFIDENTIAL - PaddyManager Intelligence Report - Page ${data.pageNumber}`, 14, 285);
                         ...
                         <div className="flex items-start gap-4">
                            ...
                            <div>
                               ...
                               <p className="text-[9px] text-slate-400 dark:text-slate-500 leading-relaxed uppercase tracking-tight">
                                  This performance statement is a consolidated record of settled agricultural lots for the specified period. All tonnage values and HUB destination metadata have been verified against PaddyManager Strategic Logistics Protocol. Settlement values represent net ROI after operational adjustments.
                               </p>
                            </div>
                         </div>
                      </div>
