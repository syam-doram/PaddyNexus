        ...
        <header className="sticky top-0 z-50 bg-white/90 dark:bg-[#0F172A]/90 backdrop-blur-xl border-b border-slate-200 dark:border-white/5 px-4 lg:px-12 py-3 lg:py-5 shrink-0">
          <div className="flex items-center justify-between gap-6 flex-wrap">
            <div className="flex items-center gap-3 lg:gap-6">
              <button
                onClick={() => navigate(-1)}
                className="group flex h-9 w-9 lg:h-11 lg:w-11 items-center justify-center rounded-xl lg:rounded-2xl bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 hover:bg-primary hover:text-background-dark transition-all"
              >
            ...
            <div className="flex items-center gap-2 lg:gap-4 flex-1 justify-end">
              ...
              <button className="flex h-9 w-9 lg:h-11 lg:w-11 items-center justify-center rounded-xl lg:rounded-2xl bg-primary text-background-dark shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
                            ...
                            <div className="flex items-center gap-3 flex-wrap">
                                <div className="flex items-center gap-2 bg-slate-50 dark:bg-white/5 p-1.5 rounded-2xl border border-slate-100 dark:border-white/5">
                                    <input 
                                        type="date" 
                                        value={selectedDate} 
                                        onChange={(e) => { setSelectedDate(e.target.value); if (e.target.value) setActiveMonth('All'); }} 
